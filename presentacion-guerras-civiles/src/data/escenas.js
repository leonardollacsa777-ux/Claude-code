...
export const ESCENAS = [
  // ---------------------------------------------------------------- 1
  {
    ...
    camara: {
      posicion: punto('salinas', 38, 14, 9),
      objetivo: punto('salinas', -14, 2.5, -1),
    },
    ambiente: 'atardecer',
    efectoTexto: 'dorado',
  ...
  // ---------------------------------------------------------------- 6
  {
    ...
    vibra: true,
    camara: {
      posicion: punto('salinas', -16, 22, 48),
      objetivo: punto('salinas', -14, 4, -1),
    },
    ambiente: 'polvo',
    efectoTexto: 'piedras',
  ...
  // ---------------------------------------------------------------- 7
  {
    ...
    camara: {
      posicion: punto('lima', -22, 17, 42),
      objetivo: punto('lima', -18, 5, -2),
    },
    ambiente: 'noche',
    efectoTexto: 'tinta',
  ...
  // ---------------------------------------------------------------- 9
  {
    ...
    camara: {
      posicion: punto('chupas', 8, 47, 58),
      objetivo: punto('chupas', -8, 40, 0),
    },
    ambiente: 'dia',
    efectoTexto: 'dorado',
  ...
  // ---------------------------------------------------------------- 10
  {
    ...
    camara: {
      posicion: punto('quito', -20, 18, 46),
      objetivo: punto('quito', -15, 5, -1),
    },
    ambiente: 'niebla',
    efectoTexto: 'piedras',
  ...
  // ---------------------------------------------------------------- 11
  {
    ...
    camara: {
      posicion: punto('jaquijahuana', -18, 18, 48),
      objetivo: punto('jaquijahuana', -16, 5, 0),
    },
    ambiente: 'dia',
    efectoTexto: 'quema',
  ...
  // ---------------------------------------------------------------- 12
  {
    ...
    camara: {
      posicion: punto('pucara', -15, 15, 42),
      objetivo: punto('pucara', -14, 8, 0),
    },
    ambiente: 'atardecer',
    efectoTexto: 'tinta',
  ...
  // ---------------------------------------------------------------- 13
  {
    ...
    camara: {
      posicion: punto('centro', 110, 120, 278),
      objetivo: punto('centro', 8, 92, 70),
    },
    ambiente: 'sobrenubes',
    efectoTexto: 'destello',
  ...
  // ---------------------------------------------------------------- 14
  {
    ...
    camara: {
      posicion: punto('centro', 16, 162, 180),
      objetivo: punto('centro', -34, 120, 40),
    },
    ambiente: 'dia',
    efectoTexto: 'dorado',
  ...
  // ---------------------------------------------------------------- 15
  {
    ...
    camara: {
      posicion: punto('centro', 58, 190, 330),
      objetivo: punto('centro', -18, 52, 70),
    },
    ambiente: 'amanecer',
    efectoTexto: 'quema',
